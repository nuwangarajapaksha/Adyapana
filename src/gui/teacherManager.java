...
public class teacherManager extends javax.swing.JFrame {
    ...
    public teacherManager() {
        ...
        teacherModel.loadTeacherTable("", teacherTableModel);
        Vector v = teacherModel.comboBoxLoad();
        dcm = new DefaultComboBoxModel(v);
        subjectComboBox.setModel(dcm);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Teacher Manager");

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Teacher Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 13))); // NOI18N

        teacherNoField.setPreferredSize(new java.awt.Dimension(10, 22));

        teacherNameField.setPreferredSize(new java.awt.Dimension(10, 22));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(teacherNameField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addComponent(teacherNoField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(teacherNoField, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(teacherNameField, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Teacher Table", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 13))); // NOI18N
        ...
        teacherTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Teacher No", "Teacher Name", "Address", "Subject"
            }
        ));
    ...
    private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButtonActionPerformed
        ...
        //String teacherNo = teacherNoField.getText();
        String teacherName = teacherNameField.getText();
        String address = addressArea.getText();
        int subject = subjectComboBox.getSelectedIndex() + 1;
        
        String result = teacherModel.registerTeacher(teacherName, address, subject);
        JOptionPane.showConfirmDialog(rootPane, result, "Message", -1, 1);
        teacherModel.loadTeacherTable("", teacherTableModel);
        
        teacherNoField.setText("");
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        String result = teacherModel.updateTeacher(teacherNo, teacherName, address, subject);
        JOptionPane.showConfirmDialog(rootPane, result, "Message", -1, 1);
        teacherModel.loadTeacherTable("", teacherTableModel);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        // TODO add your handling code here:
        String teacherNo = teacherNoField.getText();
        String result = teacherModel.deleteTeacher(teacherNo);
        JOptionPane.showConfirmDialog(rootPane, result, "Message", -1, 1);
        teacherModel.loadTeacherTable("", teacherTableModel);
    ...
    private void teacherTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_teacherTableMouseClicked
        ...
        int teacherNo = (int) teacherTableModel.getValueAt(row, 0);
        Object[] teacherData = teacherModel.getSelectedTeacherData(teacherNo);
        
        teacherNoField.setText(new String(teacherData[0] + ""));
        teacherNameField.setText((String) teacherData[1]);
        addressArea.setText((String) teacherData[2]);
        subjectComboBox.setSelectedIndex((int) teacherData[3] - 1);
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        teacherModel.loadTeacherTable(keyword, teacherTableModel);
